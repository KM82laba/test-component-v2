...
export default function Directionssubway(props) {
  ...
  return (
    <Icon
      ...
      {...getOverrideProps(overrides, "Directionssubway")}
      {...rest}
    ></Icon>
  );
}
