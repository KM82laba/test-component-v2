...
export default function Starborder(props) {
  ...
  const variants = [
    { overrides: { Starborder: {} }, variantValues: { style: "Filled" } },
    { overrides: { Starborder: {} }, variantValues: { style: "Outlined" } },
    {
      overrides: {
        Starborder: {
          paths: [
    ...
    { overrides: { Starborder: {} }, variantValues: { style: "Sharp" } },
    {
      overrides: {
        Starborder: {
          paths: [
  ...
  return (
    <Icon
      ...
      {...getOverrideProps(overrides, "Starborder")}
      {...rest}
    ></Icon>
  );
}
