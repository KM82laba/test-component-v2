...
export default function Share(props) {
  ...
  const variants = [
          ...
          paths: [
            {
              ...
              fill: "rgba(0,0,0,1)",
              fillRule: "nonzero",
              style: { transform: "translate(12.5%, 8.5%)" },
            },
          ],
        },
      },
    ...
    { overrides: { Share: {} }, variantValues: { style: "Outlined" } },
    {
      overrides: {
        Share: {
          paths: [
          ...
          paths: [
            {
              ...
              fill: "rgba(0,0,0,0.3)",
              fillRule: "nonzero",
              style: { transform: "translate(70.83%, 16.67%)" },
            },
            {
              d: "M1 2C1.55228 2 2 1.55228 2 1C2 0.447715 1.55228 0 1 0C0.447715 0 0 0.447715 0 1C0 1.55228 0.447715 2 1 2Z",
              fill: "rgba(0,0,0,0.3)",
            ...
            },
            {
              ...
              fill: "rgba(0,0,0,0.3)",
              fillRule: "nonzero",
              style: { transform: "translate(70.83%, 75.08%)" },
            },
            {
