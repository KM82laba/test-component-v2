...
export default function Staroutline(props) {
  ...
  const variants = [
    ...
    { overrides: { Staroutline: {} }, variantValues: { style: "Sharp" } },
    {
      overrides: {
        Staroutline: {
          paths: [
  ...
  return (
    <Icon
      ...
      {...getOverrideProps(overrides, "Staroutline")}
      {...rest}
    ></Icon>
  );
}
