...
export default function Dodisturbalt(props) {
  ...
  const variants = [
    ...
    { overrides: { Dodisturbalt: {} }, variantValues: { style: "Outlined" } },
    { overrides: { Dodisturbalt: {} }, variantValues: { style: "Round" } },
    { overrides: { Dodisturbalt: {} }, variantValues: { style: "Sharp" } },
    { overrides: { Dodisturbalt: {} }, variantValues: { style: "Two Tone" } },
  ];
  ...
  return (
    <Icon
      ...
      {...getOverrideProps(overrides, "Dodisturbalt")}
      {...rest}
    ></Icon>
  );
}
