...
export default function Notifications(props) {
  ...
  const variants = [
    ...
    { overrides: { Notifications: {} }, variantValues: { style: "Outlined" } },
    {
      overrides: {
        Notifications: {
          paths: [
    ...
    },
    {
      overrides: {
        Notifications: {
          paths: [
            {
              d: "M8 19.5C9.1 19.5 10 18.6 10 17.5L6 17.5C6 18.6 6.89 19.5 8 19.5ZM14 13.5L14 8.5C14 5.43 12.36 2.86 9.5 2.18L9.5 0L6.5 0L6.5 2.18C3.63 2.86 2 5.42 2 8.5L2 13.5L0 15.5L0 16.5L16 16.5L16 15.5L14 13.5Z",
              fill: "rgba(0,0,0,1)",
              fillRule: "nonzero",
              style: { transform: "translate(16.67%, 9.38%)" },
            },
